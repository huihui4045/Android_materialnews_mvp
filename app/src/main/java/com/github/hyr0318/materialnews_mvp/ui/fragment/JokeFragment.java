...
public class JokeFragment extends BaseFragment implements BaiSiContract.BaiSiView,
    ...
    public static JokeFragment newInstance(String url) {
...
*/
    ...
    @Override
    public void refreshListData(BaiSiResult baiSiResult) {
    ...
    @Override
    public void addMoreListData(BaiSiResult baiSiResult) {
    ...
    @Override
    public void onItemClick(View view, BaiSiResult.ListBean entity) {
